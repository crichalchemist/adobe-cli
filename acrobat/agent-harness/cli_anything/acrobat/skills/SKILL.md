...
description: >-
  Adobe Acrobat DC command-line interface for PDF operations: format conversion
  (PDF→DOCX/XLSX/PPTX/PNG/etc.), page manipulation (delete/extract/rotate/reorder),
  merge, split, metadata, and text extraction. Requires Adobe Acrobat DC installed.
  Uses Acrobat's native engine for conversion; pypdf/PyMuPDF for headless operations.
agent_guidance: >-
